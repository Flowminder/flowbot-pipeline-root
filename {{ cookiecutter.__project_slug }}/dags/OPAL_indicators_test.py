...
with DAG(
    dag_id="OPAL_indicators_test",
    schedule=relativedelta(months=1),
    start_date=datetime(2020, 2, 1),
    end_date=datetime(2020, 4, 1),  # Run just three months as a test
    default_args=dict(
        retries=3,
    ...
    # Note: currently waiting a couple of days longer than usually necessary.
